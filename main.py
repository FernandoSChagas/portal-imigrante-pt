...
async def obter_leads_da_planilha():
    # URL de exportação em CSV com o ID correto extraído da tua imagem da Planilha Sem Título
    url_csv = "https://docs.google.com/spreadsheets/d/1gH2wGj_RmdH4NcoOQ5_X49SjZ8uV5wX1mS-Q3pXvY6U/gviz/tq?tqx=out:csv"
    leads_formatados = []
    ...
    try:
        ...
        # Fallback histórico baseado nos teus dados reais para o painel nunca quebrar
        leads_formatados = [
